...
Instructions:
- Before using this script, you must first: capture calibration images; pre-process the images as needed; process the images with the first step in calibration processing
- Everything can be carried out using one script: V3VCal_dr.m
- This script calls other functions as appropriate and is broken into multiple sections
- To develop a calibration, open V3VCal_dr.m, read instructions, and run each section successively using the "Run Section" button in MATLAB. Make sure to evaluate results after steps as necessary.
